...
```{r Q3}
crit = qt(c(0.025,0.975), 123,lower.tail = TRUE)#-1.98

lower_crit = qt(0.025, 123, lower.tail = TRUE)
upper_crit = qt(0.975, 123,lower.tail = FALSE)

#The critical t- values are +-1.1.979
...
CI = mean(gen$bill_length_mm, na.rm = TRUE) + (crit * sse)
CI

#The Confidence Interval is 46.95 and 48.05
...
# The confidence Interval is lower = 46.9749 and upper = 48.0623
...
legend(
  ...
  lty=c(1,2,3),col=c(1,8,14), inset=c(.1,.1))
```
